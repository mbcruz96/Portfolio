...
**Otsu Thresholding**
- Implemented the Otsu thresholding algorithm for binary image segmentation
- This implementation iteratively uses each pixel intensity from 0-255 to calculate the intra class variance between the two distributions using the current iteration's pixel intensity as the separating boundary of the distributions.
